...
1. Navigate to the ["API Settings"](https://manage.sanity.io/projects/cy19d1pt/settings/api) page of this Sanity.io project. Then click "Add new token" and create new "write" token.
...
To start editing your site, you can use the Sanity interface at https://bike4all-51b06.sanity.studio/.
...
Generated at `2021-03-07T18:32:39.808Z` by Stackbit version `0.3.50`.